    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            if (ciclos != 0 && jogador1.getPosicaox() == jogador2.getPosicaox() && jogador1.getPosicaoy() == jogador2.getPosicaoy()) {
                ...
                System.out.println();
                System.out.println("|--------Setor(" + jogador2.getPosicaox() + "/" + jogador2.getPosicaoy() + ")-------|");
                System.out.println("|                         |");
                ...
                System.out.println();
                System.out.println("|--------Setor(" + jogador1.getPosicaox() + "/" + jogador1.getPosicaoy() + ")-------|   |--------Setor(" + jogador2.getPosicaox() + "/" + jogador2.getPosicaoy() + ")-------|");
                System.out.println("|                         |   |                         |");
            ...
            if (ciclos == 4 || ciclos == 8 || ciclos == 12 || ciclos == 16 || ciclos == 20 || ciclos == 24 || ciclos == 28 || ciclos == 32 || ciclos == 36 || ciclos == 40 || ciclos == 44 || ciclos == 48) {
                Setores setorAux1 = tabu.getTabu()[jogador2.getPosicaox()][jogador2.getPosicaoy()];
                if (setorAux1.getInimigos().size() > 0) {
                    for (Inimigo inimigo : setorAux1.getInimigos()) {
